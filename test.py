...
df = pd.read_csv("/Users/aleksandr/data_analysis/vk/vk-scripts/surface.csv")

xlist = ['Russia', 'NaN', 'Kazakhstan', 'Ukraine', 'USA', 'Belarus', 'Norway',
       'Moldova', 'Kyrgyzstan', 'Japan', 'Latvia', 'Azerbaijan', 'Germany',
       'France', 'Greece', 'Turkey', 'United Kingdom', 'Argentina',
       'Israel', 'Estonia', 'Poland', 'South Korea', 'Tajikistan',
       'Sint Maarten', 'Luxembourg', 'China', 'Ethiopia', 'Angola',
       'Finland', 'Spain', 'Canada', 'Lithuania', 'Austria', 'Armenia',
       'Georgia', 'Mexico', 'Bulgaria', 'United Arab Emirates',
       'Singapore', 'Albania', 'Australia', 'India', 'Thailand', 'Andorra',
       'Mali', 'Italy', 'Faroe Islands', 'New Zealand', 'Uzbekistan',
       'Monaco', 'Niue', 'Portugal', 'Switzerland', 'Afghanistan',
       'Romania', 'Maldives', 'Turkmenistan']
